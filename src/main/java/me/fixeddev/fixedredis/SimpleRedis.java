...
public class SimpleRedis implements Redis {
    ...
    SimpleRedis(VelocityCorePlugin plugin, String serverId, Gson gson, JedisPool jedisPool, Jedis listenerConnection) {
        this.plugin = plugin;
    ...
    static class SimpleRedisBuilder implements Builder {
        ...
        public SimpleRedisBuilder(VelocityCorePlugin plugin) {
            this.plugin = plugin;
        }
