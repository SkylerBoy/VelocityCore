...
public class RedisMessenger implements Messenger {
    ...
    private VelocityCorePlugin plugin;
    private Gson gson;
    ...
    public RedisMessenger(JedisPool jedisPool, Jedis listenerConnection, VelocityCorePlugin plugin, String serverId, Gson gson) {
    ...
    private void register(String channel) {
        ...
        CompletableFuture.runAsync(() -> listenerConnection.subscribe(pubSub, channel));
    }
